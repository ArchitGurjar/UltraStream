...
class DetailsActivity : AppCompatActivity() {
    ...
    private fun renderEpisodes() {
        ...
        // For simplicity, use a RecyclerView or just show in a placeholder – we'll use the existing rv_episodes
        // Since we don't have a recycler view in the layout, we'll add one dynamically or use a LinearLayout
        // For now, just assume we have a RecyclerView with id rv_episodes in the layout (we'll add it)
        // Since we already have the adapter, we can attach it to a RecyclerView.
        // As we don't have one, we'll just log.
    }
